...
public class BuzonFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button lsBtnNuevo= view.findViewById(R.id.LsBtnNuevoSugerencia);
        lsBtnNuevo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent= new Intent(getActivity(), NuevaSugerenciaActivity.class);
